...
# Load packages # 
package.list <- c('muscle', 'ape', 'seqinr', 'phytools', 'phangorn', 'phylobase', 'adephylo', 'geiger', 'picante', 'stats', 'RColorBrewer', 'caper', 'plyr', 'reshape')
...
```{r}
# Subset the normalized trait data
#umax <- traits.norm.na[ ,2]
#A <- traits.norm.na[ ,1]
#L <- traits.norm.na[ ,3]
...
#plotTree(cw<-reorder(ml.rooted),mar=c(5.1,2.1,2.1,0.1))
#par(mar=c(5.1,0.1,2.1,2.1))
# Plot barplot of normalized proportional changes
#barplot(A[cw$tip.label],horiz=TRUE,names.arg="")
#title(xlab="% Change in Biomass")
...
#par(mar=c(5.1,0.1,2.1,2.1))
# Plot barplot of normalized proportional changes
#barplot(L[cw$tip.label],horiz=TRUE,names.arg="")
#title(xlab="% Change in lag time")
...
#par(mar=c(5.1,0.1,2.1,2.1))
# Plot barplot of normalized proportional changes
#barplot(umax[cw$tip.label],horiz=TRUE,names.arg="")
#title(xlab="% Change in umax")



# Plot barplot of normalized proportional changes
plotTree.barplot(ml.rooted,traits.norm.na, args.barplot = list(beside=TRUE, xlim = c(-3,3),
    legend.text=TRUE,space=c(0,1.5),args.legend=list(x=-1.35,y=17), xlab="% Change in growth parameter with Rpf"))
