...
boxplot(umaxDelta~Genus , las=3 , 
        data=u, ylab=" ", cex.lab=0.85 , cex.axis=0.75)
mtext("% Maximum growth rate change with treatment", side = 2, line = 2.25, cex = 1)
abline(a=0, b=0, col="Black", lty=2)

par(mar=c(7,3.85,0.5,0.5))
boxplot(L~Genus , las=3 , 
        data=l, ylab=" ", cex.lab=0.85 , cex.axis=0.75)
mtext("% Lag time change with treatment", side = 2, line = 2.25, cex = 1)
abline(a=0, b=0, col="Black", lty=2)

par(mar=c(7,3.85,0.5,0.5))
boxplot(A~Genus , las=3 , 
        data=a, ylab=" ", cex.lab=0.85 , cex.axis=0.75)
mtext("% Biomass yeild change with treatment", side = 2, line = 2.25, cex = 1)
abline(a=0, b=0, col="Black", lty=2)
