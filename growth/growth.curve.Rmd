...
plot(od.cont[,1], od.cont[,2], xlim = c(0, 625), ylim = c(-0.5, 4), type = "b", 
     pch = 22, bg = "grey20", col = "black", cex = 2, ylab = "", xlab = "", 
...
axis(side = 1, lwd.ticks = 2, cex.axis = 1, las = 1, mgp = c(1, 1, 0),
...
points(od.late[,1], od.late[,2], pch = 22, lty=2, bg="grey20", col="black", lwd = 2, cex = 2, cex.lab = 1.5)
#points(od.late[,1], od.late[,3], pch = 22, lty=2, bg="grey", col="black", lwd = 2, cex = 2, cex.lab = 1.5)
#points(od.late[,1], od.late[,4], pch = 22, lty=2, bg="grey", col="black", lwd = 2, cex = 2, cex.lab = 1.5)
#points(od.late[,1], od.late[,5], pch = 22, lty=2, bg="grey", col="black", lwd = 2, cex = 2, cex.lab = 1.5)
