...
## Test for Gram + vs. Gram - Rpf effect
...
anova(gram.L)
# significant effect of Gram*Treatment (P = 0.05)
```
...
## maybe rotate should come earlier? Or naming should come after?

x <- phylo4d(tree, tip.data = cohen.d[])

table.phylo4d.j(x, treetype = "phylo", rotate.node = 13,
                symbol = "colors", show.node = FALSE, cex.label = 0.65, 
