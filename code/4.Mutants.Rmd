...
```{r}
png(filename="~/GitHub/Rpf/figures/Fig4A.png",
...
mtext(do.call(expression, x.lab.cont),side = 1, 
          line = 1.5, at = 1.5, cex = 1, col = "black")

x.lab.wild <- list(bquote("+Rpf"))
mtext(do.call(expression, x.lab.wild),side = 1, 
          line = 1.5, at = 4, cex = 1, col = "black")

#x.lab.wild.2 <- list(bquote("Wild-"),bquote(type))
#mtext(do.call(expression, x.lab.wild.2), side = 1, 
#          line = 2.25:4, at = 4, cex = 0.75, col = "gray40")

x.lab.wild.2 <- list(bquote("WT"))
mtext(do.call(expression, x.lab.wild.2), side = 1, 
          line = 2.5, at = 4, cex = 0.75, col = "gray40")

x.lab.mut <- list(bquote("+Rpf"))
mtext(do.call(expression, x.lab.mut),side = 1, 
          line = 1.5, at = 6.5, cex = 1, col = "black")

x.lab.mut.2 <- list(bquote(Delta[E %->% A]))
mtext(do.call(expression, x.lab.mut.2),side = 1, 
          line = 2.5, at = 6.5, cex = 0.75, col = "gray40")
