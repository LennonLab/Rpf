...
png(filename="~/../GitHub/Rpf/figures/Fig4.png",  # Just Venus's computer
    width = 1200, height = 1200, res = 96*2)
...
# Weird sample growth parameters as a result of experiment
...
plot(jitter(rep(2, length(od.E54A$OD600)), amount = 0.1), od.E54A$OD600, ylim = c(-0.2, 3.5), xlim = c(0.5, 5.5), pch = 21, col = "lightgrey", bg = "lightgrey", lwd = 2, cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis= 1.5, las = 1, ylab = "", xlab = "")
box(lwd=2) 
points(jitter(rep(4, length(od.E54A.wt$OD600)), amount = 0.1), od.E54A.wt$OD600, pch = 21, bg = "lightgrey", col = "lightgrey", lwd = 2, cex = 1.7)

points(2, mean(od.E54A$OD600), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
points(4, mean(od.E54A.wt$OD600), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
...
arrows(x0 = c(2), y0 = od.table$mean[which(od.table$Treatment == "E54A")], y1 = od.table$LCI[which(od.table$Treatment == "E54A")], angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(2), y0 = od.table$mean[which(od.table$Treatment == "E54A")], y1 = od.table$UCI[which(od.table$Treatment == "E54A")], angle = 90,
       length=0.1, lwd = 2)
arrows(x0 = c(4), y0 = od.table$mean[which(od.table$Treatment == "E54AWT")], y1 = od.table$LCI[which(od.table$Treatment == "E54AWT")], angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(4), y0 = od.table$mean[which(od.table$Treatment == "E54AWT")], y1 = od.table$UCI[which(od.table$Treatment == "E54AWT")], angle = 90,
       length=0.1, lwd = 2)
...
plot(jitter(rep(2, length(od.E54K$OD600)), amount = 0.1), od.E54K$OD600, ylim = c(-0.2, 3.5), xlim = c(0.5, 5.5), pch = 21, col = "lightgrey", bg = "lightgrey", lwd = 2, cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis= 1.5, las = 1, ylab = "", xlab = "")
box(lwd=2) 
points(jitter(rep(4, length(od.E54K.wt$OD600)), amount = 0.1), od.E54K.wt$OD600, pch = 21, bg = "lightgrey", col = "lightgrey", lwd = 2, cex = 1.7)

points(2, mean(od.E54K$OD600), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
points(4, mean(od.E54K.wt$OD600), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
...
arrows(x0 = c(2), y0 = od.table$mean[which(od.table$Treatment == "E54K")], y1 = od.table$LCI[which(od.table$Treatment == "E54K")], angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(2), y0 = od.table$mean[which(od.table$Treatment == "E54K")], y1 = od.table$UCI[which(od.table$Treatment == "E54K")], angle = 90,
       length=0.1, lwd = 2)
arrows(x0 = c(4), y0 = od.table$mean[which(od.table$Treatment == "E54KWT")], y1 = od.table$LCI[which(od.table$Treatment == "E54KWT")], angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(4), y0 = od.table$mean[which(od.table$Treatment == "E54KWT")], y1 = od.table$UCI[which(od.table$Treatment == "E54KWT")], angle = 90,
       length=0.1, lwd = 2)
# Make x-axis labels
mtext('E54K', side = 1, line = 1, at = 2, cex = 1)
mtext('WT', side = 1, line = 1, at = 4, cex = 1)

plot(jitter(rep(2, length(od.E54Q$OD600)), amount = 0.1), od.E54Q$OD600, ylim = c(-0.2, 3.5), xlim = c(0.5, 5.5), pch = 21, col = "lightgrey", bg = "lightgrey", lwd = 2, cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis= 1.5, las = 1, ylab = "", xlab = "")
box(lwd=2) 
points(jitter(rep(4, length(od.E54Q.wt$OD600)), amount = 0.1), od.E54Q.wt$OD600, pch = 21, bg = "lightgrey", col = "lightgrey", lwd = 2, cex = 1.7)

points(2, mean(od.E54Q$OD600), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
points(4, mean(od.E54Q.wt$OD600), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
...
arrows(x0 = c(2), y0 = od.table$mean[which(od.table$Treatment == "E54Q")], y1 = od.table$LCI[which(od.table$Treatment == "E54Q")], angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(2), y0 = od.table$mean[which(od.table$Treatment == "E54Q")], y1 = od.table$UCI[which(od.table$Treatment == "E54Q")], angle = 90,
       length=0.1, lwd = 2)
arrows(x0 = c(4), y0 = od.table$mean[which(od.table$Treatment == "E54QWT")], y1 = od.table$LCI[which(od.table$Treatment == "E54QWT")], angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(4), y0 = od.table$mean[which(od.table$Treatment == "E54QWT")], y1 = od.table$UCI[which(od.table$Treatment == "E54QWT")], angle = 90,
       length=0.1, lwd = 2)
# Make x-axis labels
mtext('E54Q', side = 1, line = 1, at = 2, cex = 1)
mtext('WT', side = 1, line = 1, at = 4, cex = 1)

plot(jitter(rep(2, length(od.trnc$OD600)), amount = 0.1), od.trnc$OD600, ylim = c(-0.2, 3.5), xlim = c(0.5, 5.5), pch = 21, col = "lightgrey", bg = "lightgrey", lwd = 2, cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis= 1.5, las = 1, ylab = "", xlab = "")
box(lwd=2) 
points(jitter(rep(4, length(od.Trnc.wt$OD600)), amount = 0.1), od.Trnc.wt$OD600, pch = 21, bg = "lightgrey", col = "lightgrey", lwd = 2, cex = 1.7)

points(2, mean(od.trnc$OD600), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
points(4, mean(od.Trnc.wt$OD600), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
...
arrows(x0 = c(2), y0 = od.table$mean[which(od.table$Treatment == "Trnc")], y1 = od.table$LCI[which(od.table$Treatment == "Trnc")], angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(2), y0 = od.table$mean[which(od.table$Treatment == "Trnc")], y1 = od.table$UCI[which(od.table$Treatment == "Trnc")], angle = 90,
       length=0.1, lwd = 2)
arrows(x0 = c(4), y0 = od.table$mean[which(od.table$Treatment == "TrncWT")], y1 = od.table$LCI[which(od.table$Treatment == "TrncWT")], angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(4), y0 = od.table$mean[which(od.table$Treatment == "TrncWT")], y1 = od.table$UCI[which(od.table$Treatment == "TrncWT")], angle = 90,
       length=0.1, lwd = 2)
# Make x-axis labels
mtext('Trnc', side = 1, line = 1, at = 2, cex = 1)
mtext('WT', side = 1, line = 1, at = 4, cex = 1)
# Add outside Y axis 
mtext(expression('Final Biomass Yield (OD600)'), side = 2,
      outer = TRUE, cex = 1.5, line = 1 , adj = 0.5)

# Plot EnzCheck Assay results
plot(jitter(rep(2, length(E54A.e$Absorbance)), amount = 0.1), E54A.e$Absorbance, ylim = c(0, 100000), xlim = c(0.5, 5.5), pch = 21, col = "darkgrey", bg = "darkgrey", lwd = 2, cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis= 1.5, las = 1, ylab = "", xlab = "")
box(lwd=2) 
...
points(2, mean(E54A.e$Absorbance), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
...
arrows(x0 = c(2), y0 = enz.table$mean[which(enz.table$Protein == "E54A")], y1 = enz.table$LCI[which(enz.table$Protein == "E54A")], angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(2), y0 = enz.table$mean[which(enz.table$Protein == "E54A")], y1 = enz.table$UCI[which(enz.table$Protein == "E54A")], angle = 90,
       length=0.1, lwd = 2)
arrows(x0 = c(4), y0 = enz.table$mean[which(enz.table$Protein == "E54AWT")], y1 = enz.table$LCI[which(enz.table$Protein == "E54AWT")], angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(4), y0 = enz.table$mean[which(enz.table$Protein == "E54AWT")], y1 = enz.table$UCI[which(enz.table$Protein == "E54AWT")], angle = 90,
       length=0.1, lwd = 2)
...
plot(jitter(rep(2, length(E54K.e$Absorbance)), amount = 0.1), E54K.e$Absorbance, ylim = c(0, 100000), xlim = c(0.5, 5.5), pch = 21, col = "darkgrey", bg = "darkgrey", lwd = 2, cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis= 1.5, las = 1, ylab = "", xlab = "")
box(lwd=2) 
...
points(2, mean(E54K.e$Absorbance), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
...
plot(jitter(rep(2, length(E54Q.e$Absorbance)), amount = 0.1), E54Q.e$Absorbance, ylim = c(0, 100000), xlim = c(0.5, 5.5), pch = 21, col = "darkgrey", bg = "darkgrey", lwd = 2, cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis= 1.5, las = 1, ylab = "", xlab = "")
box(lwd=2) 
...
points(2, mean(E54Q.e$Absorbance), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
...
plot(jitter(rep(2, length(trnc.e$Absorbance)), amount = 0.1), trnc.e$Absorbance, ylim = c(0, 100000), xlim = c(0.5, 5.5), pch = 21, col = "darkgrey", bg = "darkgrey", lwd = 2, cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis= 1.5, las = 1, ylab = "", xlab = "")
box(lwd=2) 
...
points(2, mean(trnc.e$Absorbance), pch = 21, col = "black", 
       bg = "NA", lwd = 2, cex = 2.5)
...
## Double check the proportional difference, something seems off
```{r}
rm(list=ls())
getwd()
#setwd("~/GitHub/Rpf")
...
# Load gompertz output data from run 1
...
# Label information in both datasets 
...
# A) Calculate % change with Rpf treatment of each growth curve parameter
    # Biomass yeild (A)
...
# B) Phylognetic analysis of generality assay results # 
...
# Import data #
# Reordering rows so that tree will recognize data
target <- c("Pedobacter", "Arthrobacter1", "Arthrobacter2", "Azospirillium", "Mycobacterium", 
            "Pseudomonas", "Janthinobacterium", "Variovorax", "Micrococcus", "Curtobacterium",
            "Rhodococcus", "Bacillus")
traits <- traits[match(target,traits$Genus), ]
...
# A) Does rpf effect on growth parameters vary among species (ANOVA)
# two-factor ANOVA
...
summary(generality.L.anova)
    # Significant effect of Rpf treatment on L (p=0.0147)
    # Highly significant effect of genus (p < 0.001)
    # Non-significant effect of treatment and strain interaction (p=0.4019)
generality.A.anova <- aov(A ~ Treatment*Genus, data = gc)
summary(generality.A.anova)
    # Significant effect of Rpf treatment (p < 0.001)
...
# C) Statistical tests: Are effects influenced by whether strain is Gram + vs. Gram -?
# two-factor ANOVA
# Gram status 
...
summary(generality.g.L.anova)
    # Non-significant main effect of Rpf treatment (p=0.55)
    # Significant main effect of Gram status on Lag time (p=0.007)
    # Non-significant interaction effect (0.66)
...
# D) Statistical test: Testing for Phylogenetic signal
# Pagel's Lambda 
# Rescale tree
...
#E) Generate figure to show Rpf effects on phylogeny 

# I still haven't figured out how to add the sem to the figures below 
...
# Lag time
tree.L <- plotTree.barplot(ml.rooted, L , args.barplot = list(beside=TRUE, xlim = c(-2,2), 
...
# Simple bargraph figure 
ggplot(data=gc, aes(x=Genus, y=A, fill=Treatment)) + 
