...
# Make x-axis labels
mtext('E54A', side = 1, line = 1.5, at = 2, cex = 1.5)
mtext('WT', side = 1, line = 1.5, at = 4, cex = 1.5)
...
arrows(x0 = c(4), y0 = od.table$mean[which(od.table$Treatment == "E54KWT")], y1 = od.table$UCI[which(od.table$Treatment == "E54KWT")], angle = 90,
       length=0.1, lwd = 2)
# Make x-axis labels
mtext('E54K', side = 1, line = 1.5, at = 2, cex = 1.5)
mtext('WT', side = 1, line = 1.5, at = 4, cex = 1.5)
...
arrows(x0 = c(4), y0 = od.table$mean[which(od.table$Treatment == "E54QWT")], y1 = od.table$UCI[which(od.table$Treatment == "E54QWT")], angle = 90,
       length=0.1, lwd = 2)
# Make x-axis labels
mtext('E54Q', side = 1, line = 1.5, at = 2, cex = 1.5)
mtext('WT', side = 1, line = 1.5, at = 4, cex = 1.5)
...
arrows(x0 = c(4), y0 = od.table$mean[which(od.table$Treatment == "TrncWT")], y1 = od.table$UCI[which(od.table$Treatment == "TrncWT")], angle = 90,
       length=0.1, lwd = 2)
# Make x-axis labels
mtext('Trnc', side = 1, line = 1.5, at = 2, cex = 1.5)
mtext('WT', side = 1, line = 1.5, at = 4, cex = 1.5)
# Add outside Y axis 
mtext(expression('Biomass (OD600)'), side = 2,
