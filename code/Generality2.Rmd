...
df.info <- as.data.frame(gc[c(1:10, 21:32), 4:7])
df <- cbind(df, df.info) 
...
plot(jitter(rep(1, length(df.norm.Mic$L)), amount = 0.1), df.norm.Mic$L,
     ylim = c(-3, 3), xlim = c(0.5, 6.5), pch = 21, col = "grey", bg = "grey", lwd = 2,
...
axis(side = 1, lwd.ticks = 2, cex.axis = 1.25, las = 1,
     labels = F, at = c(1, 2, 3,4,5,6), las =3)
...
arrows(x0 = c(1, 2, 3,4,5,6), y0 = df.table$mean, y1 = df.table$LCI, angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(1, 2, 3,4,5,6), y0 = df.table$mean, y1 = df.table$UCI, angle = 90,
       length=0.1, lwd = 2)
...
arrows(x0 = c(1, 2, 3, 4, 5, 6), y0 = df.A.table$mean, y1 = df.A.table$LCI, angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(1, 2, 3, 4, 5, 6), y0 = df.A.table$mean, y1 = df.A.table$UCI, angle = 90,
       length=0.1, lwd = 2)
...
plot(jitter(rep(1, length(df.norm.Mic$umax)), amount = 0.1), df.norm.Mic$umax,
     ylim = c(-3, 3.5), xlim = c(0.5, 6.5), pch = 21, col = "grey", bg = "grey", lwd = 2,
           cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis = 1.5,
      las = 1, ylab = "", xlab = "")
      box(lwd = 2)
#points(jitter(rep(2, length(df.norm.Art1$A)), amount = 0.1), df.norm.Art1$A, pch = 21, 
...
axis(side = 1, lwd.ticks = 2, cex.axis = 1.25, las = 1,
     labels = c("Mic", "Art2", "Cur", "Myc", "Bac", "Jan"), 
     at = c(1, 2, 3,4,5,6), las =3)
...
arrows(x0 = c(1, 2, 3 , 4, 5, 6), y0 = df.umax.table$mean, y1 = df.umax.table$LCI, angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(1, 2, 3, 4, 5, 6), y0 = df.umax.table$mean, y1 = df.umax.table$UCI, angle = 90,
       length=0.1, lwd = 2)
